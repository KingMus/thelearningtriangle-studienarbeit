...
\newcommand{\matrikelnr}{3252172 und 44....}
\newcommand{\kurs}{TINF15B2}
\newcommand{\firma}{Fiducia \& GAD IT AG }
\newcommand{\ort}{, Karlsruhe}
\newcommand{\abgabe}{18.09.2017}
...
\input{abkuerzungen}					% Datei mit Abkürzungen laden
...
\include{erklaerung} 				% Einbinden der eidestattlichen Erklärung
...
\include{inhalt}
%\include{Inhalt/situationfiducia}
%\include{Inhalt/semanticweb}
%\include{Inhalt/graknproject}
%\include{Inhalt/artifical}
